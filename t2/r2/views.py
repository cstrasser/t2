...
def category(request, category_name_url):
    ...
    if request.method == 'POST':
        ...
        print "context view Query %s " %query
        if query:
    ...
    print "return %r " %context_dict['query']
    return render(request, 'r2/category.html', context_dict)
...
def suggest_category(request):
        ...
        return render(request, 'r2/cats.html', {'cat_list': cat_list })
